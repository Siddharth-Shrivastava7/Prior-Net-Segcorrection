...
parser.add_argument("--random_bin_augment",action='store_true', default=False,
                        help="using augmentation during training")   
parser.add_argument("--num_patch_perturb", type=int, default=10,  # may be req 
...
class BaseDataSet(data.Dataset): 
    def __init__(self, args, root, list_path,dataset, num_class, ignore_label=255, set='val'):
        ...
        self.fixed = 0
        ## mask paths 
        self.per_gt_val_path = '/home/sidd_s/scratch/dataset/acdc_trainval/rgb_anon/night/synthetic/val/synthetic_manual_dannet_random_size_shape'
...
def init_model(args): 
    if args.small_model: 
        ...
        model = network.modeling.__dict__[args.model](num_classes=args.num_classes, output_stride=args.output_stride, num_ip_channels = args.num_ip_channels, pretrained_backbone=False)   
